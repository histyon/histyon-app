  ...
  return (
    <form action={formAction} className="flex flex-col h-full" noValidate>
        ...
        {state.status === 'error' && state.message && (
            <div className="mx-6 mb-4 bg-red-50 border border-red-200 text-red-600 px-4 py-4 rounded-xl text-sm flex items-start gap-3 shadow-sm animate-in fade-in slide-in-from-top-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="relative">
                        ...
                        <select 
                            ...
                            className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl appearance-none cursor-pointer outline-none focus:ring-2 focus:ring-black focus:ring-inset transition-all"
                        >
        ...
        <div className="mt-4 pt-4 border-t border-gray-100 flex items-center gap-3 px-6 pb-2">
