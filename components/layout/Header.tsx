...
export async function Header({ variant, userProfile }: HeaderProps) {
  return (
    <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200 w-full">
      {/* QUESTO DIV COMANDA TUTTO: max-w-7xl centrato e padding 6 fisso */}
        ...
        <div className="flex items-center gap-6">
            {variant === 'app' && userProfile && (
                <>
                    ...
                    <form action={signout}>
                        <button className="flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-red-600 hover:bg-red-50 px-3 py-2 rounded-lg transition-all">
