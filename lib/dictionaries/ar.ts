export const ar = {
  ...
  landing: {
    hero: {
      badge: "HISTYON v1.0",
      title_line1: "تشخيص رقمي",
      title_line2: "بدون مساومة.",
      description: "المنصة الشاملة للتخزين الآمن لشرائح WSI والتحليل المورفومتري المساعد.",
      ctaAccess: "طلب الوصول",
      ctaDocs: "وثائق"
    },
    workflow: {
      title: "سير عملك،",
      title_colored: "ببساطة أسرع.",
      description: "لقد قضينا على وقت التوقف. قم بتحميل جيجابايت من البيانات النسيجية في ثوانٍ.",
      card_header_secure: "HIPAA آمن",
      card_patient_label: "مريض",
      card_patient_name: "أحمد، محمد",
      card_patient_id: "ID: #8492-BX",
      card_status: "التحليل جاهز",
      card_ai_active: "طبقة الذكاء الاصطناعي نشطة",
      card_action_btn: "عرض التقرير",
      step1_title: "استيعاب سحابي",
      step1_desc: "تحميل مباشر لتخزين مشفر.",
      step2_title: "معالجة AI",
      step2_desc: "تحليل نسيجي آلي.",
      step3_title: "التقارير",
      step3_desc: "وصول فوري للنتائج."
    },
    features: {
      title: "تميز سريري",
      title_colored: "وأمان البيانات.",
      subtitle: "الأمان ليس خياراً. إنه أساس بنيتنا.",
      feat1_title: "أرشيف WSI غير محدود",
      feat1_desc: "مساحة سحابية آمنة لجميع شرائحك الرقمية.",
      feat2_title: "رأي ثانٍ",
      feat2_desc: "خوارزميات التعلم العميق تبرز مناطق الاهتمام (ROI).",
      feat2_trusted: "موثوق من المختبرات الحديثة",
      feat3_title: "الخصوصية بالتصميم",
      feat3_desc: "بيانات المرضى معزولة ومشفرة."
    },
    footer: {
      copyright: "Histyon. جميع الحقوق محفوظة.",
