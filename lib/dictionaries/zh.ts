export const zh = {
  ...
  landing: {
    hero: {
      ...
      title_line1: "数字化诊断",
      title_line2: "毫不妥协。",
      description: "用于WSI切片安全存储和辅助形态计量分析的一体化平台。",
      ctaAccess: "申请访问",
      ctaDocs: "文档"
    },
    workflow: {
      title: "您的工作流程，",
      title_colored: "更加快速。",
      description: "我们消除了停机时间。几秒钟内上传数GB的组织学数据。",
      card_header_secure: "HIPAA 安全",
      card_patient_label: "患者",
      card_patient_name: "王小明",
      card_patient_id: "ID: #8492-BX",
      card_status: "分析就绪",
      card_ai_active: "AI 层激活",
      card_action_btn: "查看报告",
      step1_title: "云端摄取",
      step1_desc: "直接上传至加密存储。",
      step2_title: "AI 处理",
      step2_desc: "自动化组织分析。",
      step3_title: "报告",
      step3_desc: "即时获取结果。"
    ...
    features: {
      title: "临床卓越",
      title_colored: "与数据安全。",
      subtitle: "安全不是选项，而是我们架构的基础。",
      feat1_title: "无限 WSI 存档",
      feat1_desc: "安全云空间，随处访问您的数字切片。",
      feat2_title: "第二意见",
      feat2_desc: "深度学习算法突出感兴趣区域 (ROI)。",
      feat2_trusted: "受现代实验室信赖",
      feat3_title: "隐私设计",
      feat3_desc: "患者数据隔离并加密。"
    },
    footer: {
      copyright: "Histyon. 保留所有权利。",
      legal: "法律信息",
      docs: "文档",
      contact: "联系我们",
      login: "登录",
